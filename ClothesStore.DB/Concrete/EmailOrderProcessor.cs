...
namespace ClothesStore.DB.Concrete
{
    public class EmailSettings
    {
        ...
        public string FileLocation = @"C:\Games";
    }
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                StringBuilder body = new StringBuilder()
                    .AppendLine("New oder is processed")
                    .AppendLine("---")
                    .AppendLine("Oder   :");
                ...
                foreach (var line in cart.Lines)
                {
                    ...
                    body.AppendFormat("{0} x {1} (Total cost : {2:c}",
                ...
                body.AppendFormat("Total cost: {0:c}", cart.ComputeTotalValue())
                    ...
                    .AppendFormat("Gift wrap: {0}",
                        shippingInfo.GiftWrap ? "Add" : "None");

                MailMessage mailMessage = new MailMessage(
                                       emailSettings.MailFromAddress,	
                                       emailSettings.MailToAddress,		
                                       "The new order has shipped!",		
                                       body.ToString()); 				
